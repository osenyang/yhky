...
<body>
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner" style="background-color:#E9EAEB; ">
        <div class="container" >
          <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
           ...
           <a class="brand" href="${ctx}">
				...
				<img style="height: 45px;padding-left:15px" src="${ctxStatic}/images/guan-li-xi-tong.png">
<%--            <img src="${ctxStatic}/images/logo_small.png" alt="亿灵社区健康服务管理系统" > --%>
           </a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
		...
		<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error"><%=error==null?"":"com.elink.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
		</div>
        <div id="login-wraper">
            <form id="loginForm"  class="form login-form" action="${ctx}/login" method="post">
                ...
                <div class="footer">
                    ...
                    <input class="btn btn-yellow" type="submit" value="登 录"/>
                </div>
    ...
    <footer class="white navbar-fixed-bottom" style="background-color: #E9EAEB;">
		Copyright &copy; ${fns:getConfig('copyrightYear')}${fns:getConfig('productName')}
<!-- 		<a href="http://community.nug-hospital.com/admin"></a>  -->
		<%-- - Version Number   <!-- <a href="#" >http://community.nug-hospital.com</a> --> ${fns:getConfig('version')}  --%>
		<span><a  href=""><img src="${ctxStatic}/images/common_cpr_100113.gif" >京ICP备xxxxxxxx号</a></span>
    </footer>
  </body>
</html>