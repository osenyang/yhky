...
function fileQueued(file) {
	try {
		...
		var filelist = document.getElementById("progressContainer"+file.id);
       	filelist.style.paddingLeft="50px";
       	filelist.style.background="#F0F5FF url('script/SWFUoload/file-icon/wmv.png') no-repeat 5px 5px";
