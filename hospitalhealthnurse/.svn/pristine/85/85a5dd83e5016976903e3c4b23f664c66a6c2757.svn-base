...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label"><span class="tishi">*</span>角色名称:</label>
			<div class="controls">
...
<!-- 		<div class="control-group"> -->
<!-- 			<label class="control-label"><span class="tishi">*</span>数据范围:</label> -->
<!-- 			<div class="controls"> -->
...
<!-- 		</div> -->
		<div class="control-group">
			<label class="control-label"><span class="tishi">*</span>角色授权:</label>
			<div class="controls">
