...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static void saveImageAsJpg(String fromFileStr, String saveToFileStr,
		...
		Thumbnails.of(fromFileStr).size(width, hight).toFile(saveToFileStr); 
	}

	public static void processUploadedFile(File parent, FileItem item)
			throws Exception {
	...
	public static void main (String argv[]) {
        try{        	
            System.out.println (getFileName("http://14.29.68.166:8862/entertainment/2015/04/31afb8d97b8a437caebb7d2b53a0d724.apk"));   
        } catch(Exception e){
            e.printStackTrace();
        }
	}
