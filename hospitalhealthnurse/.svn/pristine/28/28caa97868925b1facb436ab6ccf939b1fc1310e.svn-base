 ...
 * @version 2016-11-15
 */
public class ElderPlanCareVO implements Serializable {
	...
	public void setNuserGradeQuartersNm(String nuserGradeQuartersNm) {
		this.nuserGradeQuartersNm = nuserGradeQuartersNm.trim();
	}
	...
	public void setDeitNuserQuartersNm(String deitNuserQuartersNm) {
		this.deitNuserQuartersNm = deitNuserQuartersNm.trim();
	}
	...
	public void setActivityIntoleranceQuartersNm(
			String activityIntoleranceQuartersNm) {
