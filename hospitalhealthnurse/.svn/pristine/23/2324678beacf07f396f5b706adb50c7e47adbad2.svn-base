package com.elink.hospitalhealthnurse.common.utils.sms.utils;
...
public class MobClient {
	...
	/**** mob App key ***/
	public static final String app_key = "8e321e518dd0";
	/**** mob App secret ***/
	public static final String app_secret = "ef1206a6b869a494e48ef310acc2b6e9";

	/**** mob 短信验证码验证接口 ***/
	public static final String mob_verify_url = "https://api.sms.mob.com/sms/verify";
	/**** mob IOS短信验证码验证接口 ***/
	public static final String mob_verify_ios_url = "https://webapi.sms.mob.com/sms/verify";

	/**** 国家编号，默认为中国 ***/
	public static final String default_zone = "86";
	
	/**** 短信验证码验证成功返回标志 ***/
	public static final String reponse_code_sucess = "200";
