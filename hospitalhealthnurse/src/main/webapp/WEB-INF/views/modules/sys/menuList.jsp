...
<body>
	<form:form id="searchForm" action="${ctx}/sys/menu/" method="post" class="breadcrumb form-search">
		<shiro:hasPermission name="sys:menu:edit"><a href="${ctx}/sys/menu/form"><input id="btnSubmit" class="btn btn-yellow" type="button" value="新增菜单" /></a></shiro:hasPermission>
	</form:form>
	...
	<form id="listForm" method="post">
		...
		<shiro:hasPermission name="sys:menu:edit"><div class="form-actions pagination-left">
			<input id="btnSubmit" class="btn btn-yellow" type="button" value="保存排序" onclick="updateSort();"/>
