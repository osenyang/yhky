...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			//alert("${ctx}${url}");
			//alert("${ctx}${url}${fn:indexOf(url,'?')==-1 ? '?' : '&'}&extId=${extId}&module=${module}&t="+new Date().getTime());
...
<body>
	<div style="position:absolute;right:20px;top:13px;cursor:pointer;" onclick="search();">
	...
	<div id="search" class="control-group hide" style="padding:10px 0 0 15px;">
		...
		<input type="text" class="empty" id="key" name="key" maxlength="50" style="width:170px;">
	</div>
