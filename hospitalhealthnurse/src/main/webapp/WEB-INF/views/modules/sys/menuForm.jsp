...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label"><span class="tishi">*</span>上级菜单:</label>
			<div class="controls">
                <tags:treeselect id="menu" name="parent.id" value="${menu.parent.id}" labelName="parent.name" labelValue="${menu.parent.name}"
					title="菜单" url="/sys/menu/treeData" extId="" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="name"><span class="tishi">*</span>名称：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="sort"><span class="tishi">*</span>排序：</label>
			<div class="controls">
				<form:input path="sort" htmlEscape="false" maxlength="50" class="required digits"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="isShow"><span class="tishi">*</span>可见：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="isActiviti"><span class="tishi">*</span>同步到工作流：</label>
			<div class="controls">
