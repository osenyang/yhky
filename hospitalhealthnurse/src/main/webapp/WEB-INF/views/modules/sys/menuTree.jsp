...
// 				$(this).children("i").addClass("icon-white");
		...
		function changeClick(str){
			$(".accordion-body a").each(function(){
				if($(this).html().indexOf(str) > 0){
					$("#menu li").removeClass("active");
					$(this).parent().addClass("active");
				}
			});
		...
		<!-- 		    </div> -->
					<div class="accordion-body"> 
			    		<ul class="nav nav-list">
			    			<li><a href="${fn:indexOf(menu.href, '://') eq -1?ctx:''}${not empty menu.href?menu.href:'/404'}" target="${not empty menu.target?menu.target:'mainFrame'}" ><i></i>|&nbsp;${menu.name}</a></li>
