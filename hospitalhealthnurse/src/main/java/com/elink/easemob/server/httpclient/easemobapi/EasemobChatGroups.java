package com.elink.easemob.server.httpclient.easemobapi;
...
import com.elink.easemob.server.common.Roles;
import com.elink.easemob.server.httpclient.utils.HTTPClientUtils;
import com.elink.easemob.server.httpclient.vo.ClientSecretCredential;
import com.elink.easemob.server.httpclient.vo.Credential;
import com.elink.easemob.server.httpclient.vo.EndPoints;
...
//		System.out.println(deleteChatGroupNode.toString());
         ...
         * -H 'Authorization: Bearer {token}'
		 */
//		String chatgroupid = "1433322351766358";
...
//		System.out.println(getAllMemberssByGroupIdNode.toString());
         ...
         * -H 'Authorization: Bearer {token}'
		 */
//		String addToChatgroupid = "1433322351766358";
//		String toAddUsername = "kenshinnuser_5";x
...
//		System.out.println(addUserToGroupNode.toString());
         ...
         * -H 'Authorization: Bearer {token}'
		 */
//		String delFromChatgroupid = "1433322351766358";
//		String toRemoveUsername = "kenshinnuser_2";
...
//		System.out.println(deleteUserFromGroupNode.asText());
         ...
         * -H 'Authorization: Bearer {token}'
		 */
		String username = "130101194610085304";
...
//		
		 ...
		 */
//		String toAddBacthChatgroupid = "1433990403754916";
