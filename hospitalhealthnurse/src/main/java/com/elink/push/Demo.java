...
import com.elink.push.android.AndroidBroadcast;
import com.elink.push.android.AndroidCustomizedcast;
import com.elink.push.android.AndroidFilecast;
import com.elink.push.android.AndroidGroupcast;
import com.elink.push.android.AndroidUnicast;
import com.elink.push.android.AndroidListcast;
import com.elink.push.ios.IOSBroadcast;
import com.elink.push.ios.IOSCustomizedcast;
import com.elink.push.ios.IOSFilecast;
import com.elink.push.ios.IOSGroupcast;
import com.elink.push.ios.IOSUnicast;
...
public class Demo {
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setPredefinedKeyValue("device_tokens", "AsNVetm-kre5manV3F_LRSKrcohAGukKMjWLXRIzELZY");
		unicast.setPredefinedKeyValue("ticker", "Android unicast ticker");
		unicast.setPredefinedKeyValue("title",  "中文标题");
		unicast.setPredefinedKeyValue("text",   "测试内容");
	...
	public void sendAndroidListcast() throws Exception {
		...
		unicast.setPredefinedKeyValue("timestamp", this.timestamp);
		// TODO Set your device token
		unicast.setPredefinedKeyValue("device_tokens", "AsNVetm-kre5manV3F_LRSLLCoDCW-sWAfHBxWN-_AqC");
		unicast.setPredefinedKeyValue("ticker", "Android unicast ticker");
		unicast.setPredefinedKeyValue("title",  "预警");
		unicast.setPredefinedKeyValue("text",   "预警说明");
		unicast.setPredefinedKeyValue("after_open", "go_activity");
		unicast.setPredefinedKeyValue("activity", "com.elinkdeyuan.neighbornurse.ui.activity.userinfo.NurseRecordActivity");
		unicast.setPredefinedKeyValue("display_type", "notification");
		// TODO Set 'production_mode' to 'false' if it's a test device. 
	...
	public static void main(String[] args) {
		...
		Demo demo = new Demo("5591f3f367e58e8890007020", "yci78yrrvityczet0ioajtysao5ydvn9");
		try {
